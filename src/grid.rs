...
impl Grid{
    ...
    fn generate_map(canvas_width: f32, canvas_height: f32, cell_side_length_meters: u32) -> HashMap<Quadrant, Vec<Vec<Cell>>>  {
        ...
        let number_of_cells_x_axis = ((canvas_width/2.0)/(canvas_pixels_to_meters_ratio*cell_side_length_meters as f32)); //appending extra cell because there is space left between last column and edge of screen 
